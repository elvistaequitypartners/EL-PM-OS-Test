...
**Template:**
"For [Component 4: who cares most], who [struggle], [product name] is the [Component 5: market category] that [Component 3: value enabled]. Unlike [Component 1: competitive alternatives], we [Component 2: unique attributes]."
...
1. **Could a competitor say the same thing?** If yes, the unique attributes aren't distinct enough.
2. **Does the category frame make the value obvious?** If someone sees only the category, would they understand why they need this?
3. **Does the ICP see themselves in "who cares most"?** If the ICP segment is too vague, real customers won't self-identify.
