...
Key insight: The promotion to Senior PM is almost never about doing more of the same work faster. It's about doing categorically different work — influencing strategy, not just executing it — and making the people around you more effective, not just completing your own tasks.
...
**Behavior 2 — Evidence-driven influence:**
A Senior PM doesn't just have opinions — they have arguments backed by user data, metrics, and competitive insight. They win prioritization arguments with evidence, not seniority.
...
**Behavior 3 — Proactive risk identification:**
...
Signs you're there: You've delayed or reshaped a launch because of a risk you identified in advance — and the team respected the call.

**Behavior 4 — Cross-functional leadership:**
...
**Behavior 5 — Making others better:**
...
If one behavior is dramatically weaker than the others, it's the blocker — fix it first.

## Step 5 — The Promotion Conversation
...
- "You need more scope" = They're waiting for an opportunity, not a gap you can close today — push for a specific opportunity
- "You're almost there" = Ask them to define "almost" in behavioral terms, with a timeline

## Step 6 — The 6-Month Plan
...
- Document the problem analysis before writing the PRD — share it with the manager
- Set up a weekly 30-minute 1:1 with manager specifically to discuss PM development

**Month 3–4: Build the evidence**
...
**Month 5–6: Demonstrate the pattern**
...
- Identify one instance where you made a colleague's work better — document it
